...
النطاق الحالي: `createSchoolUser` بس. باقي عمليات Bug 2 (الاستيراد الجماعي، الترفيع السنوي،
المؤشرات، الإشعارات) لسا من جهة العميل — ممكن تنتقل لهون بنفس الطريقة لاحقًا.
